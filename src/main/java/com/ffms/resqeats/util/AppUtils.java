...
public class AppUtils {
    ...
    public String getShopResource() {
        return AppConstants.RESOURCE_SHOP;
    }

    public String getFoodResource() {
        return AppConstants.RESOURCE_FOOD;
    }

    public String getOrderResource() {
        return AppConstants.RESOURCE_ORDER;
    }

    public String getCartResource() {
        return AppConstants.RESOURCE_CART;
    }

    public String getPaymentResource() {
        return AppConstants.RESOURCE_PAYMENT;
    }

    public String getNotificationResource() {
        return AppConstants.RESOURCE_NOTIFICATION;
    }
